...
// グローバル状態の画像リストとメニュー機能を使用
const { imageList, jsonFileInput, handleJSONImport } = useAppMenu();
...
// グローバルのresetAllにローカル状態リセットを組み合わせ
const { resetAll: globalResetAll } = useAppMenu();
const resetAll = () => {
  globalResetAll();
  resetLocalState();
};
